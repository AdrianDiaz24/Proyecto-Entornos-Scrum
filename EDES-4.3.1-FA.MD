...
* Captura del archivo `build.gradle.kts` con los plugins añadidos.
* Captura de terminal con instalación y sincronización exitosa de Gradle.
* Captura de la estructura del proyecto (`src/main/kotlin/...`).
