    ...
    describe("UsuarioService") {
        ...
        describe("eliminarUsuarioPorNombre") {
            it("debe llamar al método eliminarUsuarioPorNombre del repositorio y devolver true") {
                every { mockRepositorio.eliminarUsuarioPorNombre("Abel") } returns true

                val resultado = servicio.eliminarUsuarioPorNombre("Abel")

                verify { mockRepositorio.eliminarUsuarioPorNombre("Abel") }
                resultado shouldBe true
            }

            it("debe devolver false si no se puede eliminar el usuario") {
                every { mockRepositorio.eliminarUsuarioPorNombre("Abel") } returns false
